                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <select id="select-tipo" class="form-control">
                                            @foreach($arrayTipoProveedor as $item)
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" maxlength="300" class="form-control" id="nombrecomercial-nuevo" autocomplete="off">
                                    </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group" >
                                        <label class="control-label">Tipo de Proveedor: </label>
                                        <select id="select-tipo-editar" class="form-control">
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label>Nombre Comercial</label>
                                        <input type="text" maxlength="300" class="form-control" id="nombrecomercial-editar" autocomplete="off">
                                    </div>
...
@stop
    ...
    <script>
        ...
        function nuevo(){
            ...
            var nombrecomercial = document.getElementById('nombrecomercial-nuevo').value;
            ...
            axios.post(urlAdmin+'/admin/proveedor/informacion',{
                ...
                .then((response) => {
                    ...
                    if(response.data.success === 1){
                        ...
                        $('#nombrecomercial-editar').val(response.data.info.nombre_comercial);

                        document.getElementById("select-tipo-editar").options.length = 0;

                        $.each(response.data.arraytipos, function( key, val ){
                            if(response.data.info.id_tipo_proveedor == val.id){
                                $('#select-tipo-editar').append('<option value="' +val.id +'" selected="selected">'+val.nombre+'</option>');
                            }else{
                                $('#select-tipo-editar').append('<option value="' +val.id +'">'+val.nombre+'</option>');
                            }
                        });
        ...
        function editar(){
            ...
            var nombrecomercial = document.getElementById('nombrecomercial-editar').value;
