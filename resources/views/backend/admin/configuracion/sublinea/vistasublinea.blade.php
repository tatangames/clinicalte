...
@section('js')
    ...
    <script>
        $(function () {
            const ruta = "{{ url('/admin/sublinea/tabla/index') }}";
    ...
    <script>
        ...
        function recargar(){
            var ruta = "{{ url('/admin/sublinea/tabla/index') }}";
        ...
        function nuevo(){
            ...
            axios.post(urlAdmin+'/admin/sublinea/nuevo', formData, {
            })
                .then((response) => {
                    closeLoading();
        ...
        function informacion(id){
            ...
            axios.post(urlAdmin+'/admin/sublinea/informacion',{
                'id': id
            })
                .then((response) => {
                    closeLoading();
        ...
        function editar(){
            ...
            axios.post(urlAdmin+'/admin/sublinea/editar', formData, {
            })
                .then((response) => {
                    closeLoading();
                    if(response.data.success === 1){
