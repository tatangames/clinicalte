                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <select id="select-tipo" class="form-control">
                                            @foreach($arrayTipoFarmaceutica as $item)
...
@stop
    ...
    @section('js')
        ...
        <script>
            $(function () {
                const ruta = "{{ url('/admin/contenidofarmaceutica/tabla/index') }}";
    ...
    <script>
        ...
        function recargar(){
            var ruta = "{{ url('/admin/contenidofarmaceutica/tabla/index') }}";
        ...
        function nuevo(){
            ...
            axios.post(urlAdmin+'/admin/contenidofarmaceutica/nuevo', formData, {
            })
                .then((response) => {
                    closeLoading();
        ...
        function informacion(id){
            ...
            axios.post(urlAdmin+'/admin/contenidofarmaceutica/informacion',{
                'id': id
            })
                .then((response) => {
                    closeLoading();
        ...
        function editar(){
            ...
            axios.post(urlAdmin+'/admin/contenidofarmaceutica/editar', formData, {
            })
                .then((response) => {
                    closeLoading();
                    if(response.data.success === 1){
