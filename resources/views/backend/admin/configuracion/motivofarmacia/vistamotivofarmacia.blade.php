...
@section('title', 'Motivo Farmacia')

@section('content_header')
    <h1>Motivo Farmacia</h1>
@stop
...
@stop
    ...
    @section('js')
        ...
        <script>
            $(function () {
                const ruta = "{{ url('/admin/motivofarmacia/tabla/index') }}";
    ...
    <script>
        ...
        function recargar(){
            var ruta = "{{ url('/admin/motivofarmacia/tabla/index') }}";
        ...
        function nuevo(){
            ...
            axios.post(urlAdmin+'/admin/motivofarmacia/nuevo', formData, {
            })
                .then((response) => {
                    closeLoading();
        ...
        function informacion(id){
            ...
            axios.post(urlAdmin+'/admin/motivofarmacia/informacion',{
                'id': id
            })
                .then((response) => {
                    closeLoading();
        ...
        function editar(){
            ...
            axios.post(urlAdmin+'/admin/motivofarmacia/editar', formData, {
            })
                .then((response) => {
                    closeLoading();
                    if(response.data.success === 1){
