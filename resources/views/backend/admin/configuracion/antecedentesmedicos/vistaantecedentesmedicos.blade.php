...
@section('title', 'Antecedente Médico')

@section('content_header')
    <h1>Antecedente Médico</h1>
@stop
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group" >
                                        <label class="control-label">Tipo de Antecedente: </label>
                                        <select id="select-tipo" class="form-control">
                                            @foreach($arrayTipoAnte as $item)
...
@stop
    ...
    @section('js')
        ...
        <script>
            $(function () {
                const ruta = "{{ url('/admin/antecedentesmedicos/tabla/index') }}";
    ...
    <script>
        ...
        function recargar(){
            var ruta = "{{ url('/admin/antecedentesmedicos/tabla/index') }}";
        ...
        function nuevo(){
            ...
            axios.post(urlAdmin+'/admin/antecedentesmedicos/nuevo', formData, {
            })
                .then((response) => {
                    closeLoading();
        ...
        function informacion(id){
            ...
            axios.post(urlAdmin+'/admin/antecedentesmedicos/informacion',{
                'id': id
            })
                .then((response) => {
                    closeLoading();
                    if(response.data.success === 1){
                        ...
                        $.each(response.data.arraytipos, function( key, val ){
                            if(response.data.info.id_tipo == val.id){
        ...
        function editar(){
            ...
            axios.post(urlAdmin+'/admin/antecedentesmedicos/editar', formData, {
            })
                .then((response) => {
                    closeLoading();
                    if(response.data.success === 1){
