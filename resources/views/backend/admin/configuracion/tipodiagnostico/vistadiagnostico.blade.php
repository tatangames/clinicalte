...
@section('title', 'Tipo Diagnóstico')

@section('content_header')
    <h1>Tipo Diagnóstico</h1>
@stop
...
@stop
    ...
    @section('js')
        ...
        <script>
            $(function () {
                const ruta = "{{ url('/admin/tipodiagnostico/tabla/index') }}";
    ...
    <script>
        ...
        function recargar(){
            var ruta = "{{ url('/admin/tipodiagnostico/tabla/index') }}";
        ...
        function nuevo(){
            ...
            axios.post(urlAdmin+'/admin/tipodiagnostico/nuevo', formData, {
            })
                .then((response) => {
                    closeLoading();
        ...
        function informacion(id){
            ...
            axios.post(urlAdmin+'/admin/tipodiagnostico/informacion',{
                'id': id
            })
                .then((response) => {
                    closeLoading();
        ...
        function editar(){
            ...
            axios.post(urlAdmin+'/admin/tipodiagnostico/editar', formData, {
            })
                .then((response) => {
                    closeLoading();
                    if(response.data.success === 1){
